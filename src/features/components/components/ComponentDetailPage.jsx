				...
				return (
					...
					>
						...
						<DialogContent>
							...
							<DialogDescription>This is a modal dialog component with orange theming.</DialogDescription>
	...
	return (
		<div className={styles.container}>
			...
			<section className={styles.section}>
				...
				<div className={styles.demo}>{renderDemo()}</div>
			</section>
